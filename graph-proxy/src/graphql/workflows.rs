...
impl From<argo_workflows_openapi::IoArgoprojWorkflowV1alpha1Workflow> for Workflow {
    fn from(value: argo_workflows_openapi::IoArgoprojWorkflowV1alpha1Workflow) -> Self {
        Self {
...
impl WorkflowsQuery {
    ...
    async fn workflow(
        ...
        let namesapce = format!("{}{}-{}", proposal_code, proposal_number, visit);
        let mut url = server_url.clone();
        url.path_segments_mut()
            .unwrap()
            .extend(["api", "v1", "workflows", &namesapce, &name]);
